...
#define DHTPIN D2 // Ajusta este pin según tu conexión
#define DHTTYPE DHT11
DHT dht(DHTPIN, DHTTYPE);

#define placa "ESP8266"
#define Voltage_Resolution 3.3 // Voltaje máximo de referencia del ESP8266 (3.3V)
#define pinAOUT A0 // Pin analógico en ESP8266 conectado al pin AOUT del módulo
#define type "MQ-7" // Tipo de sensor MQ-7
#define ADC_Bit_Resolution 10 // El ESP8266 tiene un ADC de 10 bits
...
void setup() {
  ...
  float calcR0 = 0;
  for(int i = 1; i <= 10; i++) {
    MQ7.update(); // Leer datos, el ESP8266 leerá el voltaje del pin analógico
...
void EnvioDatos() {
  if (WiFi.status() == WL_CONNECTED) {
    ...
    float humedad = dht.readHumidity() + 19;  // Aplicar corrección de humedad según lo medido en el parque tecnológico

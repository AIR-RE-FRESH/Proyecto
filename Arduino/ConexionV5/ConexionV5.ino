...
// Pines para los LEDs
#define LED_ROJO 18    // Pin para LED rojo
#define LED_AMARILLO 19 // Pin para LED amarillo
...
// URL del servidor
const char* serverName = "http://10.10.1.220:8000/api/guardar";
...
void EnvioDatos() {
  if (WiFi.status() == WL_CONNECTED) {
    ...
    float humedad = data.humidity + 19;  // Aplicar corrección de humedad según lo medido
    ...
    // Condiciones para encender LEDs
    if ((humedad < 40 || humedad > 60) || (ppm < 300 || ppm > 400)) {

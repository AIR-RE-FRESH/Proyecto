...
<script type="module">
  ...
  const firebaseConfig = {
    apiKey: "AIzaSyDX2DUUvRuXfh1GI8EJZbF8wFjyedMwwPg",
    authDomain: "air-re-fresh.firebaseapp.com",
    projectId: "air-re-fresh",
    storageBucket: "air-re-fresh.appspot.com",
    messagingSenderId: "944327699868",
    appId: "1:944327699868:web:7a7eb385f55d0c7903ec59",
    measurementId: "G-Y59D2KNX20"
  };
